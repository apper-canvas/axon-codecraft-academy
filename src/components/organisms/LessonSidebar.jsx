    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed lg:static inset-y-0 left-0 z-50 w-80 bg-white border-r border-surface-200 overflow-y-auto"
        >
          {/* Header */}
          ...
          <div className="p-4 space-y-2">
            {lessons.map((lesson, index) => {
              ...
              // A lesson is locked if it's not the first lesson and the previous one is not completed
